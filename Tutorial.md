# Tutorial (~3 pages): Securing a FaaS-Style Microservice with JWT + an API Gateway

This repository implements a Library microservice system. This document is **not** a full app walkthrough — it is a focused tutorial on one implemented topic:

> **How to expose a “Function-as-a-Service (FaaS)” style API and secure it using JWT at a central API Gateway**, while keeping the underlying service simple.

Public repo requirement (coursework): publish this repo publicly and paste the link here.

**Public repository URL:** _<replace with your GitHub/GitLab URL>_
